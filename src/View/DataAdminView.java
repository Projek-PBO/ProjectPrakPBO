...
import Controllers.DataAdminController;
...
public class DataAdminView extends javax.swing.JPanel {
    private DataAdminController controller;
    public DataAdminView() {
        initComponents();
        btnhapus.setVisible(false);
        btnbatal.setVisible(false);
        DataAdmin model = new DataAdmin();
        controller = new DataAdminController(model);
        loadData();
    }
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        int selectedRow = tabel_databuku.getSelectedRow();
        if (selectedRow >= 0) {
            String id = (String) tabel_databuku.getValueAt(selectedRow, 0);
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        // TODO add your handling code here:
            int selectedRow = tabel_databuku.getSelectedRow();
            String id = selectedRow >= 0 ? tabel_databuku.getValueAt(selectedRow, 0).toString() : "";
            String nama = txt_nama.getText();
            String username = txt_username.getText();
            String password = txt_password.getText();
            String level = (String) CB_level.getSelectedItem();
            controller.saveAdmin(id, nama, username, password, level);
            loadData();
            Main_Panel.removeAll();
...
//        controller.searchAdminByName(search);
