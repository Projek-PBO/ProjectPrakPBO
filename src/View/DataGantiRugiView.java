...
import Controllers.DataGantiRugiController;
...
public class DataGantiRugiView extends javax.swing.JPanel {
    private DataGantiRugiController controller;
    
    public DataGantiRugiView() {
        initComponents();
        DataGantiRugi model = new DataGantiRugi();
        controller = new DataGantiRugiController(model);
        loadData();
    }
